...
list_of_orbits = [(1, 3), (2.5, 10), (7, 2), (6, 6), (4, 3), (100, 100)]


def find_farthest_orbits(list_of_orbits) -> tuple:
    return max(list_of_orbits, key=lambda x: 3.14 * x[0] * x[1] if x[0] != x[1] else 0)
